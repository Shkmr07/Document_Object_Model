...
const generateCard = (el) =>{
    ...
    let rate_val = document.createElement("h4");
    ...
    rate_val.textContent = `${el.rating.rate} ⭐ | ${el.rating.count}`;
    name.textContent = el.title;
    cate.textContent = el.category;
    amount.textContent = `$ ${el.price}`;

    container.append(image,rate_val,name,cate,amount);
    sub_main.append(container);
